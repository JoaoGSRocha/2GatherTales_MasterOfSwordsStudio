...
public class ItemsCity  extends  AbstractItems {
    ...
    Item armour = new Item("armour", 10, new BitmapFont(),
            new Texture("armour.jpg"), new Rectangle(484, 163,43,66),true,
            510, 180);
    Item gloves = new Item("gloves", 10, new BitmapFont(),
            new Texture("gloves.jpg"), new Rectangle(482, 240, 47,23),true,
            510, 255);
    Item sword = new Item("sword", 10, new BitmapFont(),
            new Texture("sword.jpg"), new Rectangle(589,160,22, 73),true,
            595, 180);
    Item shield = new Item("shield", 10, new BitmapFont(),
            new Texture("shield.jpg"), new Rectangle(535,215, 48, 48),true,
            560, 230);
    Item boots = new Item("boots", 10, new BitmapFont(),
            new Texture("boots.jpg"), new Rectangle(535, 160, 48, 48),true,
            560, 180);
